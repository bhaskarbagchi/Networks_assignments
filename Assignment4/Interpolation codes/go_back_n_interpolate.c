...
double Spline_evaluation(double x_in, double y_in)
{
    ...
    double coeff [] = {2.3716699111112933E+02, 4.2690695176025047E+03, 8.3321228515663533E+03, 3.4698929541819115E+02, 3.5926190341000770E+03, 6.9142265727445165E+03, 2.3507753967380464E+02, 4.6784587675344701E+03, 8.5152532222910177E+03};
    int nx = 6;
    int ny = 6;
    int kx = 2;
    int ky = 2;
